...
// add by nishi
class SingleStereoNodelet : public nodelet::Nodelet {
  public:
    SingleStereoNodelet() {}
    ...
    void onInit() {
      ...
      single_stereo = new Single_StereoCamera(node, pnode);
    }

    ~SingleStereoNodelet() {
      if (single_stereo) delete single_stereo;
    }

  private:
    Single_StereoCamera *single_stereo;
};
...
// add by nishi
PLUGINLIB_EXPORT_CLASS(uvc_camera::SingleStereoNodelet, nodelet::Nodelet)
